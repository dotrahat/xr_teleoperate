...
class DualRingPinchGesture:
    ...
    def update_tele_data(self, tele_data) -> bool:
        return self.update(
...
class AlternatingFistGesture:
    """Detect left-right-left-right fists, with full releases between steps."""
    ...
    def update_tele_data(self, tele_data) -> bool:
        return self.update(tele_data.left_hand_squeeze, tele_data.right_hand_squeeze)
...
class TripleDoublePinchGesture:
    ...
    def update(self, left_pinching: bool, right_pinching: bool, now: float | None = None) -> bool:
        ...
        if not left_pinching and not right_pinching:
    ...
    def update_tele_data(self, tele_data) -> bool:
        return self.update(tele_data.left_hand_pinch, tele_data.right_hand_pinch)
